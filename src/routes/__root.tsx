  ...
  head: () => ({
    meta: [
      ...
      { title: "The Foothill Girls Hostel — Premium Girls Hostel Inside MIT-WPU, Kothrud" },
      {
        name: "description",
        content:
          "Premium girls hostel inside MIT-WPU Campus, Kothrud. Safe, peaceful, hygienic. Spacious rooms, WiFi, CCTV, hygienic vegetarian food. Book a visit today.",
      },
      ...
      { property: "og:description", content: "Premium girls hostel inside MIT-WPU Campus, Kothrud. Safe, peaceful, hygienic. Spacious rooms, WiFi, CCTV, hygienic vegetarian food. Book a visit today." },
      { name: "twitter:card", content: "summary_large_image" },
      { name: "twitter:title", content: "The Foothill Girls Hostel — Premium Girls Hostel Inside MIT-WPU, Kothrud" },
      { name: "twitter:description", content: "Premium girls hostel inside MIT-WPU Campus, Kothrud. Safe, peaceful, hygienic. Spacious rooms, WiFi, CCTV, hygienic vegetarian food. Book a visit today." },
      { property: "og:image", content: "https://pub-bb2e103a32db4e198524a2e9ed8f35b4.r2.dev/7996352e-b0cd-4cf9-8f91-3a544ad8d08f/id-preview-aa9e3c18--03878bcc-7ce3-4dd2-b70a-e32ac2a957f7.lovable.app-1783509694215.png" },
      { name: "twitter:image", content: "https://pub-bb2e103a32db4e198524a2e9ed8f35b4.r2.dev/7996352e-b0cd-4cf9-8f91-3a544ad8d08f/id-preview-aa9e3c18--03878bcc-7ce3-4dd2-b70a-e32ac2a957f7.lovable.app-1783509694215.png" },
    ],
    links: [
